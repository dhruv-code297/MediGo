          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
                Book appointments, access medical records, and get personalized health advice with ease. Your health, our priority. 
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild variant="outline" size="lg" className="bg-emerald-700/30 hover:bg-muted/80">
                <Link href={"/doctors"}>
                  Find Doctors
                </Link>
                  </Button>
...
<Image 
  ...
  fill 
  priority 
  className="object-contain md:pt-14 rounded-xl scale-110 md:scale-135"
/>
            </div>
          </div>
        </div>
